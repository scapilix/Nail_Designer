...
const Footer = () => {
  return (
    <footer id="contactos" className="bg-white border-t border-gray-100 pt-24 pb-12 overflow-hidden">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              {[Instagram, Youtube, Mail].map((Icon, idx) => (
                <a key={idx} href="#" className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center text-dark hover:bg-primary hover:text-white transition-all transform hover:-translate-y-1">
          ...
          <div>
            ...
            <form className="flex">
              <input 
                ...
                className="w-full bg-secondary border-none rounded-l-custom px-4 py-3 text-sm focus:ring-1 focus:ring-primary outline-none"
              />
